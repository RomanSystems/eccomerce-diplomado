...
export class ProductListComponent implements OnInit {
  ...
  listProducts: Array<ProductModel> = this.listProductsGlobal.products;
  ...
  ngOnInit() {
    ...
    //PARA EL SEO
    this.title.setTitle('Catálogo de Productos | Mi Tienda Online');
    this.meta.addTags([
      {
        name: 'description',
        content: 'Descubre nuestra amplia selección de productos con envío rápido y precios bajos.'
      },
      {name: 'keywords', content: 'productos, tienda online, ofertas, compras'},
      {name: 'author', content: 'Mi Tienda'},
      {name: 'robots', content: 'index, follow'},
      // Open Graph para Facebook y redes sociales
      {property: 'og:title', content: 'Catálogo de Productos'},
      {property: 'og:description', content: 'Encuentra lo que buscas en nuestra tienda online.'},
      {property: 'og:type', content: 'website'},
      {property: 'og:url', content: 'https://mitienda.com/products'},
      {property: 'og:image', content: 'https://mitienda.com/assets/preview.jpg'},
      // Twitter Card
      {name: 'twitter:card', content: 'summary_large_image'},
      {name: 'twitter:title', content: 'Catálogo de Productos'},
      {name: 'twitter:description', content: 'Los mejores precios en productos de calidad.'},
      {name: 'twitter:image', content: 'https://mitienda.com/assets/preview.jpg'}
    ]);
  }
  ...
  trackById(index: number, product: ProductModel) {
    return product.id;
  }
